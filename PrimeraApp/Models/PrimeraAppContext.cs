...
{
    public class PrimeraAppContext : DbContext
    {
        ...
        // 
        // System.Data.Entity.Database.SetInitializer(new System.Data.Entity.DropCreateDatabaseIfModelChanges<PrimeraApp.Models.PrimeraAppContext>());

        public PrimeraAppContext() : base("name=PrimeraAppContext")
        {
        }
